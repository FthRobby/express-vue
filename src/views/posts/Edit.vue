                ...
                <div class="card border-0 rounded shadow">
                    <div class="card-body">
                        ...
                        <form @submit.prevent="update">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm me-2 mt-3">UPDATE</button>
                            <router-link :to="{name: 'posts.index', params:{id: post.id }}" class="btn btn-sm btn-warning me-2 mt-3">BATAL</router-link>
                        </form>                        
