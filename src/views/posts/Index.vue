            ...
            <div class="col-md-12">
                <div class="card border-0 rounded shadow">
                    <div class="card-body">
                        <h4>DATA POST</h4>
                        <hr>
                        <router-link :to="{name: 'posts.create'}" class="btn btn-md btn-primary">TAMBAH POST</router-link>
                            ...
                            <tbody>
                                <tr v-for="(post, index) in posts" :key="index">
                                    ...
                                    <td class="text-center">
                                        <router-link :to="{name: 'posts.edit', params:{id: post.id }}" class="btn btn-sm btn-warning me-2">EDIT</router-link>
